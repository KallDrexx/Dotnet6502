...
public class CpyTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Immediate_Equal(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Immediate_Greater(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Immediate_Less(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Immediate_Zero_Compare(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_ZeroPage_Equal(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_ZeroPage_Greater(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC4);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_ZeroPage_Less(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC4);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Absolute_Equal(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Absolute_Greater(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xCC);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Absolute_Less(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xCC);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Signed_Comparison(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void CPY_Boundary_Values(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xC0);
        var instruction = new DisassembledInstruction
        {
