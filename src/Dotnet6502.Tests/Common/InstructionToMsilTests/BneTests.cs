...
public class BneTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Branches_When_Zero_Flag_Clear(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Does_Not_Branch_When_Zero_Flag_Set(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Backward_Branch_When_Zero_Flag_Clear(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Does_Not_Affect_Other_Flags(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Does_Not_Affect_Registers(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Forward_Branch_Maximum_Positive_Offset(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_Backward_Branch_Maximum_Negative_Offset(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BNE_With_Various_Zero_States_From_Previous_Operations(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0xD0);
        var instruction = new DisassembledInstruction
        {
