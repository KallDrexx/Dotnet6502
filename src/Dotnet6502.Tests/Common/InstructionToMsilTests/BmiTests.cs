...
public class BmiTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Branches_When_Negative_Flag_Set(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Does_Not_Branch_When_Negative_Flag_Clear(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Backward_Branch_When_Negative_Flag_Set(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Does_Not_Affect_Other_Flags(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Does_Not_Affect_Registers(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Forward_Branch_Maximum_Positive_Offset(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_Backward_Branch_Maximum_Negative_Offset(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BMI_With_Various_Negative_States_From_Previous_Operations(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x30);
        var instruction = new DisassembledInstruction
        {
