...
public class BvsTests
{
    ...
    public void BVS_Branches_When_Overflow_Flag_Set()
    {
        ...
        jit.TestHal.Flags[CpuStatusFlags.Overflow] = true; // Overflow flag set
        ...
        jit.TestHal.Flags[CpuStatusFlags.Overflow].ShouldBeTrue(); // Should remain unchanged
    }
    ...
    public void BVS_Does_Not_Branch_When_Overflow_Flag_Clear()
    {
        ...
        var jit = new TestJitCompiler();
        jit.AddMethod(0x1234, allInstructions);
        jit.TestHal.Flags[CpuStatusFlags.Overflow] = false; // Overflow flag clear
        jit.RunMethod(0x1234);
        ...
        jit.TestHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse(); // Should remain unchanged
    }
    ...
    public void BVS_Backward_Branch_When_Overflow_Flag_Set()
    {
        ...
        jit.TestHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse(); // Final state: overflow flag clear (loop exit condition)
    }
    ...
    public void BVS_With_Various_Overflow_States_From_Previous_Operations()
    {
        ...
        // Test case 1: After operation that clears overflow flag (no overflow)
        {
            ...
            jit1.TestHal.Flags[CpuStatusFlags.Overflow] = false;
        ...
        // Test case 2: After operation that sets overflow flag (overflow occurred)
        {
            ...
            jit2.TestHal.Flags[CpuStatusFlags.Overflow] = true;
