...
public class BvcTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Branches_When_Overflow_Flag_Clear(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Does_Not_Branch_When_Overflow_Flag_Set(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Backward_Branch_When_Overflow_Flag_Clear(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Does_Not_Affect_Other_Flags(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Does_Not_Affect_Registers(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Forward_Branch_Maximum_Positive_Offset(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_Backward_Branch_Maximum_Negative_Offset(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void BVC_With_Various_Overflow_States_From_Previous_Operations(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x50);
        var instruction = new DisassembledInstruction
        {
