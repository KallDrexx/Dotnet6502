...
public class TyaTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void TYA_Basic(bool useInterpreter)
    {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void TYA_Zero(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x98);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void TYA_Negative(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x98);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void TYA_HighValue(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x98);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void TYA_Preserves_Other_Flags(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x98);
        var instruction = new DisassembledInstruction
        {
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void TYA_Does_Not_Affect_X_Register(bool useInterpreter)
    {
        var instructionInfo = InstructionSet.GetInstruction(0x98);
        var instruction = new DisassembledInstruction
        {
