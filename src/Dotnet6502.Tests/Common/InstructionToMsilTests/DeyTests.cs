...
public class DeyTests
{
    ...
    public void DEY_Basic()
    {
        ...
        testRunner.TestHal.YRegister.ShouldBe((byte)0x04);
    ...
    public void DEY_Zero_Result()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.TestHal.YRegister = 0x01; // 0x01 - 1 = 0x00
        testRunner.RunTestMethod();
    ...
    public void DEY_Wraparound_To_Negative()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.TestHal.YRegister = 0x00; // 0x00 - 1 = 0xFF (wraparound)
        testRunner.RunTestMethod();
    ...
    public void DEY_Negative_Result()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.TestHal.YRegister = 0x81; // 0x81 - 1 = 0x80 (still negative)
        testRunner.RunTestMethod();
    ...
    public void DEY_Positive_Non_Zero_Result()
    {
        ...
        testRunner.TestHal.YRegister.ShouldBe((byte)0x41);
        testRunner.TestHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEY_From_Maximum_Positive()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.TestHal.YRegister = 0x7F; // 127, decrement to 126 (0x7E, still positive)
        testRunner.RunTestMethod();

        testRunner.TestHal.YRegister.ShouldBe((byte)0x7E);
        testRunner.TestHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEY_From_Negative_To_Negative()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.TestHal.YRegister = 0xFE; // -2, decrement to -3 (0xFD)
        testRunner.RunTestMethod();

        testRunner.TestHal.YRegister.ShouldBe((byte)0xFD);
        testRunner.TestHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue();
        testRunner.TestHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.TestHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEY_Boundary_Value_0x80()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.TestHal.YRegister = 0x80; // -128, decrement to 127 (0x7F, becomes positive)
        testRunner.RunTestMethod();
