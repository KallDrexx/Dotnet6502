...
public class DecTests
{
    ...
    public void DEC_ZeroPage_Basic()
    {
        ...
        testRunner.NesHal.MemoryValues[0x10].ShouldBe((byte)0x04);
    ...
    public void DEC_ZeroPage_Wraparound_To_Negative()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.MemoryValues[0x30] = 0x00; // 0x00 - 1 = 0xFF
        testRunner.RunTestMethod();

        testRunner.NesHal.MemoryValues[0x30].ShouldBe((byte)0xFF);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
    ...
    public void DEC_ZeroPage_Negative_Result()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.MemoryValues[0x40] = 0x81; // 0x81 - 1 = 0x80 (negative)
        testRunner.RunTestMethod();

        testRunner.NesHal.MemoryValues[0x40].ShouldBe((byte)0x80);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEC_ZeroPageX_Basic()
    {
        ...
        testRunner.NesHal.MemoryValues[0x55] = 0x10; // 0x50 + 0x05
        testRunner.RunTestMethod();

        testRunner.NesHal.MemoryValues[0x55].ShouldBe((byte)0x0F);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEC_ZeroPageX_Wraparound()
    {
        ...
        testRunner.NesHal.MemoryValues[0x01].ShouldBe((byte)0x41);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEC_Absolute_Basic()
    {
        ...
        testRunner.NesHal.MemoryValues[0x3000].ShouldBe((byte)0x98);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue(); // 0x98 has bit 7 set
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    }
    ...
    public void DEC_AbsoluteX_Basic()
    {
        ...
        testRunner.NesHal.MemoryValues[0x200F].ShouldBe((byte)0x32);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void DEC_AbsoluteX_Zero_To_Negative()
    {
        ...
        testRunner.NesHal.MemoryValues[0x5000] = 0x00; // 0x00 - 1 = 0xFF
        testRunner.RunTestMethod();

        testRunner.NesHal.MemoryValues[0x5000].ShouldBe((byte)0xFF);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue(); // 0xFF has bit 7 set
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    }
}