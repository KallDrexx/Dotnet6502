...
public class BcsTests
{
    ...
    public void BCS_Backward_Branch_When_Carry_Set()
    {
        ...
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse(); // Final state: carry clear (loop exit condition)
    }
    ...
    public void BCS_Does_Not_Affect_Other_Flags()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Copy(new NesIr.Constant(1), new NesIr.Flag(NesIr.FlagName.Carry)), // Set carry for branch
    ...
    public void BCS_Backward_Branch_Maximum_Negative_Offset()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Binary(
                ...
                new NesIr.Flag(NesIr.FlagName.Carry)), // Set carry if X == 0
    ...
    public void BCS_With_Various_Carry_States_From_Previous_Operations()
    {
        ...
        // Test case 1: After operation that clears carry
        {
            ...
            testRunner1.NesHal.Flags[CpuStatusFlags.Carry] = false;
        ...
        // Test case 2: After operation that sets carry
        {
            ...
            testRunner2.NesHal.Flags[CpuStatusFlags.Carry] = true;
