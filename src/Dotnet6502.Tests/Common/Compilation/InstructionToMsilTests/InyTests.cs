...
public class InyTests
{
    ...
    public void INY_Basic()
    {
        ...
        testRunner.NesHal.YRegister.ShouldBe((byte)0x06);
    ...
    public void INY_Zero_Result()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.YRegister = 0xFF; // 0xFF + 1 = 0x00 (wraparound)
        testRunner.RunTestMethod();
    ...
    public void INY_Negative_Result()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.YRegister = 0x7F; // 127, increment to 128 (0x80, negative)
        testRunner.RunTestMethod();
    ...
    public void INY_Positive_Non_Zero_Result()
    {
        ...
        testRunner.NesHal.YRegister.ShouldBe((byte)0x43);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void INY_From_Zero()
    {
        ...
        testRunner.NesHal.YRegister.ShouldBe((byte)0x01);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void INY_From_Negative_To_Negative()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.YRegister = 0x80; // -128, increment to -127 (0x81)
        testRunner.RunTestMethod();

        testRunner.NesHal.YRegister.ShouldBe((byte)0x81);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void INY_Boundary_Value_0x7E()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.YRegister = 0x7E; // 126, increment to 127 (0x7F, still positive)
        testRunner.RunTestMethod();
    ...
    public void INY_Negative_To_More_Negative()
    {
        ...
        var nesIrInstructions = InstructionConverter.Convert(instruction, context);
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.YRegister = 0xFE; // -2, increment to -1 (0xFF)
        testRunner.RunTestMethod();
