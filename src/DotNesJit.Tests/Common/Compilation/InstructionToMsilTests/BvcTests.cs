...
public class BvcTests
{
    ...
    public void BVC_Backward_Branch_When_Overflow_Flag_Clear()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Binary(
                ...
                new NesIr.Flag(NesIr.FlagName.Overflow)), // Set overflow flag when X >= 3 (loop should exit)
    ...
    public void BVC_Does_Not_Affect_Other_Flags()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Copy(new NesIr.Constant(0), new NesIr.Flag(NesIr.FlagName.Overflow)), // Clear overflow for branch
    ...
    public void BVC_Backward_Branch_Maximum_Negative_Offset()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Binary(
                ...
                new NesIr.Variable(0),
                new NesIr.Constant(1),
                new NesIr.Flag(NesIr.FlagName.Overflow)), // Clear overflow flag if X == 0, set if X != 0
