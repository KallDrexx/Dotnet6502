...
public class LdxTests
{
    ...
    public void LDX_ZeroPageY_Wraparound()
    {
        ...
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.XRegister = 0x00;
        testRunner.NesHal.YRegister = 0x02;
    ...
    public void LDX_AbsoluteY_Basic()
    {
        ...
        testRunner.NesHal.XRegister.ShouldBe((byte)0x22);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void LDX_AbsoluteY_PageCrossing()
    {
        ...
        testRunner.NesHal.XRegister.ShouldBe((byte)0x88);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
    ...
    public void LDX_ZeroPageY_Negative_Value()
    {
        ...
        var testRunner = new InstructionTestRunner(nesIrInstructions);
        testRunner.NesHal.XRegister = 0x00;
        testRunner.NesHal.YRegister = 0x08;
        testRunner.NesHal.MemoryValues[0x48] = 0xC0; // 0x40 + 0x08, negative value
        testRunner.RunTestMethod();

        testRunner.NesHal.XRegister.ShouldBe((byte)0xC0);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeTrue();
        testRunner.NesHal.Flags[CpuStatusFlags.Carry].ShouldBeFalse();
        testRunner.NesHal.Flags[CpuStatusFlags.Overflow].ShouldBeFalse();
