...
public class BmiTests
{
    ...
    public void BMI_Backward_Branch_When_Negative_Flag_Set()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Binary(
                ...
                new NesIr.Flag(NesIr.FlagName.Negative)), // Set negative flag when X < 3 (loop should continue)
        ...
        testRunner.NesHal.Flags[CpuStatusFlags.Negative].ShouldBeFalse(); // Final state: negative flag clear (loop exit condition)
    }
    ...
    public void BMI_Does_Not_Affect_Other_Flags()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Copy(new NesIr.Constant(1), new NesIr.Flag(NesIr.FlagName.Negative)), // Set negative for branch
    ...
    public void BMI_Backward_Branch_Maximum_Negative_Offset()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Binary(
                ...
                new NesIr.Flag(NesIr.FlagName.Negative)), // Set negative flag if X == 0
    ...
    public void BMI_With_Various_Negative_States_From_Previous_Operations()
    {
        ...
        // Test case 1: After operation that clears negative flag (positive/zero result)
        {
            ...
            testRunner1.NesHal.Flags[CpuStatusFlags.Negative] = false;
        ...
        // Test case 2: After operation that sets negative flag (negative result)
        {
            ...
            testRunner2.NesHal.Flags[CpuStatusFlags.Negative] = true;
