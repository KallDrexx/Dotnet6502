...
public class BeqTests
{
    ...
    public void BEQ_Branches_When_Zero_Flag_Set()
    {
        ...
        testRunner.NesHal.Flags[CpuStatusFlags.Zero] = true; // Zero flag set
        ...
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeTrue(); // Should remain unchanged
    }
    ...
    public void BEQ_Does_Not_Branch_When_Zero_Flag_Clear()
    {
        ...
        var testRunner = new InstructionTestRunner(allInstructions);
        testRunner.NesHal.Flags[CpuStatusFlags.Zero] = false; // Zero flag clear
        testRunner.RunTestMethod();
        ...
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse(); // Should remain unchanged
    }
    ...
    public void BEQ_Backward_Branch_When_Zero_Flag_Set()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Copy(
                new NesIr.Variable(0),
                new NesIr.Flag(NesIr.FlagName.Zero)), // Set zero flag if X < 3 (continue looping)
        ...
        testRunner.NesHal.Flags[CpuStatusFlags.Zero].ShouldBeFalse(); // Final state: zero flag clear (loop exit condition)
    }
    ...
    public void BEQ_Does_Not_Affect_Other_Flags()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Copy(new NesIr.Constant(1), new NesIr.Flag(NesIr.FlagName.Zero)), // Set zero for branch
    ...
    public void BEQ_Backward_Branch_Maximum_Negative_Offset()
    {
        ...
        var allInstructions = new List<NesIr.Instruction>
        {
            ...
            new NesIr.Binary(
                ...
                new NesIr.Flag(NesIr.FlagName.Zero)), // Set zero flag if X == 0
    ...
    public void BEQ_With_Various_Zero_States_From_Previous_Operations()
    {
        ...
        // Test case 1: After operation that clears zero flag (non-zero result)
        {
            ...
            testRunner1.NesHal.Flags[CpuStatusFlags.Zero] = false;
        ...
        // Test case 2: After operation that sets zero flag (zero result)
        {
            ...
            testRunner2.NesHal.Flags[CpuStatusFlags.Zero] = true;
